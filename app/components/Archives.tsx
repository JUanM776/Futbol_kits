...
const seasons = [
  ...
  },
  {
    ...
    description: "Los clubes más grandes del continente. Real Madrid, Barcelona, Liverpool y más.",
    image: "/equipos_europeos/Real_madrid_local-2025.jpeg",
    accent: "from-blue-900/30",
    href: "#equipos-europeos",
  },
  {
    year: "Exclusivo",
    title: "Ediciones Especiales",
    description: "Piezas únicas y limitadas. Centenarios, ediciones doradas y colecciones irrepetibles.",
    image: "/ediciones_especiales/Colombia_dorada.jpeg",
